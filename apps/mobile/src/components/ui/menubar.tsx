  ...
  return (
    <>
      ...
      <MenubarPrimitive.Root
        className={cn(
          'bg-card border-border flex h-11 flex-row items-center gap-1 rounded-2xl border p-1 shadow-sm shadow-black/5',
          className,
        )}
  ...
  return (
    ...
    >
      <MenubarPrimitive.Trigger
        className={cn(
          'group flex items-center rounded-full px-3.5 py-2 sm:py-1.5',
          Platform.select({
